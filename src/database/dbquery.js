...
export const getCapsulesInDescOrder = 'select * from capsules where is_deleted=false and user_id=$1 and created_at <= $2 order by created_at desc limit 10'
export const getCapsulesInAscOrder = 'select * from capsules where is_deleted=false and user_id=$1 and created_at <= $2 order by created_at asc limit 10'
export const getCapsulessortbySizeInAsc = 'select * from capsules where is_deleted=false and user_id=$1 and capsule_size <= $2 order by capsule_size asc limit 10'
export const getCapsulessortbySizeInDesc = 'select * from capsules where is_deleted=false and user_id=$1 and capsule_size <= $2 order by capsule_size desc limit 10'
export const getcaplsulesbyDatemodified = 'select * from capsules where is_deleted=false and user_id=$1 and updated_at <= $2 order by updated_at desc limit 10'
...
export const getallFragments = 'select * from fragments where is_deleted=false and capsule_id=$1 and created_at <= $2 order by created_at desc limit 40'
...
export const searchfragments = 'select * from fragments where is_deleted=false and capsule_id=$1 and (tag ilike $2 or file_name ilike $2 or text_content ilike $2)'
export const filterfragments = 'select * from fragments where is_deleted=false and capsule_id=$1 and fragment_type =$2 and created_at <= $3 order by created_at desc limit 40'
export const filterdocsfragments = 'select * from fragments where is_deleted=false and capsule_id=$1 and created_at <= $2 and fragment_type != $3 and fragment_type != $4 and fragment_type != $5 order by created_at desc limit 40'
