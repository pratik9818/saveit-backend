...
export const feedbackMode = async (userid,bugs,features,improvements,suggestions) => {
    const client = await pool.connect()
    try {
         await client.query(feedbackquery , [bugs,features,improvements,suggestions,userid])
        // console.log(res);
